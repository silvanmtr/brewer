...
Brewer.MultiSelecao = (function() {
	...
	function onSelecaoClicado(){
		var selecaoCheckados = this.selecaoCheckbox.filter(':checked');
		this.selecaoTodosCheckbox.prop('checked', selecaoCheckados.length >= this.selecaoCheckbox.length);
		statusBotaoAcao.call(this, selecaoCheckados.length);
