...
public class VendasImpl implements VendasQueries {
	...
	public BigDecimal valorEstoque() {
		Optional<BigDecimal> optional = Optional.ofNullable(
				manager.createQuery("select sum(valor * quantidadeEstoque), sum(quantidadeEstoque) from Cerveja", BigDecimal.class)
					.getSingleResult());
		return optional.orElse(BigDecimal.ZERO);
	}*/
	...
	public List<VendaOrigem> totalPorOrigem() {
		List<VendaOrigem> vendasOrigem = manager.createNamedQuery("Vendas.porOrigem", VendaOrigem.class).getResultList();
