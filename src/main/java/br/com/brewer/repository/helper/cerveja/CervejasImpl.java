...
public class CervejasImpl implements CervejasQueries {
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "SELECT new br.com.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
				+ "FROM Cerveja WHERE lower(sku) like lower(:skuOuNome) OR nome like lower(:skuOuNome)";
	...
	public ValorItensEstoque valorItensEstoque() {
		String query = "select new br.com.brewer.dto.ValorItensEstoque(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Cerveja";
