...
public class ClientesController {
	...
	@ResponseBody
	public List<Cliente> pesquisar(String nome) throws IllegalAccessException{ 	
		validarTamanhoNome(nome);
		return clientes.findByNomeStartingWithIgnoreCase(nome);
	}

	private void validarTamanhoNome(String nome) throws IllegalAccessException {
	...
	public ResponseEntity<Void> tratarIllegalAccessException(IllegalAccessException e){
